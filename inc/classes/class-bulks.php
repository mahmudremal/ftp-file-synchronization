...
class Bulks {
	...
	protected function setup_hooks() {
		$this->args = [
			...
			'column'	=> 'status',
			'options'	=> [
				''       => __( 'All', 'ftp-file-synchronization' ),
				'open'   => __( 'Open', 'ftp-file-synchronization' ),
				'closed' => __( 'Closed', 'ftp-file-synchronization' ),
			]
		];
		/**
	...
	public function manage_posts_columns( $columns ) {
		...
		$columns[ $this->args[ 'column' ] ] = __( 'Status', 'ftp-file-synchronization' );
		return $columns;
	}
	/**
