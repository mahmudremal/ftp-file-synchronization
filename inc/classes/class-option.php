...
class Option {
  ...
  private $file;
	...
	protected function setup_hooks() {
		$this->file = FTPFILESYNC_PROJECT__FILE__;
		$this->plugin_slug = 'ftp-file-synchronization';
		$this->plugin_name = 'ftp-file-synchronization';
		$this->textdomain = 'ftp-file-synchronization'; // str_replace('_', '-', $plugin_slug);
	...
	public function init() {
		$this->general = (object) wp_parse_args( apply_filters( 'futurewordpress/project/settings/general', [] ), [
			'page_title'					=> __( 'Configuration.', 'ftp-file-synchronization' ),
			'menu_title'					=> __( 'Config', 'ftp-file-synchronization' ),
			'role'								=> 'manage_options',
			'slug'								=> $this->plugin_slug,
			'page_header'					=> __( 'customization page.', 'ftp-file-synchronization' ),
			'page_subheader'			=> __( 'Your setting panel from where you can control and customize.', 'ftp-file-synchronization' ),
	...
	public function add_settings_link( $links ) {
		$settings_link = '<a href="options-general.php?page='.$this->general->slug.'">' . __( 'Settings', 'ftp-file-synchronization' ) . '</a>';
		// array_push( $links, $settings_link );
		$links[] = $settings_link;
		$links[] = '<a href="https://www.fiverr.com/mahmud_remal/" target="_blank">' . __( 'Developer Support', 'ftp-file-synchronization' ) . '</a>';
		return $links;
	}
