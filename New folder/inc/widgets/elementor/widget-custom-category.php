...
class Widgets_CustomCategory extends \Elementor\Widget_Base {
	...
	public function __construct( $data = [], $args = null ) {
		...
		wp_register_style( 'listivo-child-widgets', FTPFILESYNC_BUILD_CSS_URI . '/widgets.css', [], apply_filters( 'futurewordpress/project/filesystem/filemtime', false, FTPFILESYNC_BUILD_CSS_DIR_PATH . '/widgets.css' ) );
		...
		wp_register_script( 'listivo-child-widgets', FTPFILESYNC_BUILD_JS_URI . '/widgets.js', [ 'swiper' ], apply_filters( 'futurewordpress/project/filesystem/filemtime', false, FTPFILESYNC_BUILD_JS_DIR_PATH . '/widgets.js' ), true );
...
ftp-file-synchronization
	 ...
	 * Used to determine where to display theftp-file-synchronizationor.
...
ftp-file-synchronization
	...
	public function get_categories() ftp-file-synchronization
...
ftp-file-synchronization
	...
	public function get_script_depends() ftp-file-synchronization
...
ftp-file-synchronization
	...
	protected function register_controls() {
		...
		$this->start_controls_section(
			...
			'section_content',ftp-file-synchronization
		...
		$this->add_control(ftp-file-synchronization

			'show_view_all',ftp-file-synchronization

			[

				'label' => esc_html__('Display "View All" button', 'we-make-content-crm'),

				'type' => Controls_Manager::SWITCHER,ftp-file-synchronization

				'return_value' => '1',ftp-file-synchronization
