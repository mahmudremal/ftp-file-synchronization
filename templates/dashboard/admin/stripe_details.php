...
<div>
  <div class="row">
    ...
    <div class="card card-full-width rounded m-auto to-print-this-card">
        ...
        <div class="row">
          <div class="col-sm-12">  
          <h4 class="mb-3"><?php esc_html_e( 'Invoice', 'ftp-file-synchronization' ); ?>  #<?php echo esc_html( substr( $log->session_id, -20 ) ); ?></h4>
        ...
        <div class="row">
          ...
          <div class="col-lg-3">
          <h5><?php esc_html_e( 'Bill from:', 'ftp-file-synchronization' ); ?></h5>
          <p><?php echo esc_html( $userInfo->meta->first_name . ' ' . $userInfo->meta->last_name ); ?></p>
          <p><?php echo esc_html( ! empty( $userInfo->meta->address1 ) ? $userInfo->meta->address1 : (
            ! empty( $userInfo->meta->address2 ) ? $userInfo->meta->address2 : __( 'Address not available', 'ftp-file-synchronization' )
          ) ); ?><br>
            <?php echo esc_html( $log->customer_email ); ?> </p>
          </div>
          <div class="col-lg-3">
          <h5><?php esc_html_e( 'Bill fromAmount:', 'ftp-file-synchronization' ); ?></h5>
          <h4>$<?php echo esc_html( number_format_i18n( ( $log->amount / 100 ), 2 ) ); ?></h4>
          </div>
          <div class="col-lg-2 text-end">
          <h5><?php esc_html_e( 'Invoice Date', 'ftp-file-synchronization' ); ?></h5>
        ...
        <div class="row">
          ...
          <div class="table-responsive-lg">
              ...
              <thead>
                <tr>
                  <th scope="col"><?php esc_html_e( 'Description', 'ftp-file-synchronization' ); ?></th>
                  <th scope="col"><?php esc_html_e( 'Price', 'ftp-file-synchronization' ); ?></th>
                  <th scope="col"><?php esc_html_e( 'Quantity', 'ftp-file-synchronization' ); ?></th>
                  <th class="text-end" scope="col"><?php esc_html_e( 'Sub-Total', 'ftp-file-synchronization' ); ?></th>
                </tr>
              </thead>
              <tbody>
                <tr>
                ...
                <tr>
                  <td>
                    <h5 class="mb-0"><b><?php esc_html_e( 'Net Amount', 'ftp-file-synchronization' ); ?></b></h5>
                  </td>
                  <td></td>
                  <td></td>
